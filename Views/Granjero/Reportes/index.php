...
// $consulta = "SELECT venta.id_producto,producto.nombre,producto.modelo,sum(venta.total_producto) as cantidad,producto.precioUnitario,sum(venta.total_venta) as precioVenta FROM venta INNER JOIN producto on producto.id_producto=venta.id_producto where venta.fecha_hora_venta=CURDATE()  GROUP BY venta.id_producto";

	 		$consulta = "SELECT id_pollo,peso,fecha,causa  FROM mortalidad";
