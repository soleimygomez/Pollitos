		...
		<form  action="?controller=pollito&&action=save" method="POST" class="from-registro">
         <div id="modal-reguistroU" class="w3-modal">
           <div class="w3-modal-content w3-animate-top w3-card-4">
             ...
             <input type="text" name="id_pollo" placeholder="identificador" required="" class="N">
             <input type="text" name="peso" placeholder="Peso Actual(kg)" required="" class="N">
             <input type="text" name="linea_genetica" placeholder="linea Genetica" required="" class="N">
