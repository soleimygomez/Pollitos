             ...
             <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
                    ...
                    <li>
                      ...
                      <li>
                           <li  ><a href="pollito/ir-registro-mortalidad.php" style="color: black; background-color: #FEFEFE;"><i class="zmdi zmdi-calendar-check"></i>&nbsp;&nbsp; Registro de Mortalidad</a></li>
                    </li>
     ...
     <div class="content-page-container full-reset custom-scroll-containers" >
        ...
        <nav class="navbar-user-top full-reset" style= "background-color:#c62828;color: white;" role="navigation" >
            <ul class="list-unstyled full-reset" >
                ...
                <li  class="tooltips-general exit-system-button "style="color: white;" data-href="../../controllers/cerrar-sesion.php" data-placement="bottom" title="Cerrar Sesion 2">
