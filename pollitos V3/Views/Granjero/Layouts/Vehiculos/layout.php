                ...
                <ul class="list-unstyled">
                  <li>
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled" style=" background-color: #E3E2D3 ;">
                            <li><a href="../Pollito/ir-registro.php"><i class="zmdi zmdi-account-add zmdi-hc-fw"></i>&nbsp;&nbsp; Registrar</a></li>
                            <li><a href="../Pollito/ir-tabla.php"><i class="zmdi zmdi-format-align-justify zmdi-hc-fw"></i>&nbsp;&nbsp; Listar</a></li>
                        </ul>
                    </li>
...
<br>
   ...
   <div class="w3-modal-content w3-animate-top w3-card-4">
      <header class="w3-container headerModal"> 
        ...
        <h2 class="modal-title text-center all-tittles">Registro Usuario</h2>
      </header>
      <div style="margin-top: 5%; margin-left: 10%">
        


     <input type="text" name="" placeholder="Peso Actual" required="" class="N">
    <input type="text" name="" placeholder="linea Genetica" required="" class="N">
    <input type="checkbox" name="" value="Galpon Limpio" required="" class="N"> Galpon Limpio<br>
      ...
      <footer class="w3-container headerModal" style="margin-top:20px; height: 60px">
        <button type="button" class="btn btn-primary boton-modal" style="background-color:#472E2E" data-dismiss="modal"><i class="zmdi zmdi-thumb-up"></i> &nbsp; Registrar</button>
