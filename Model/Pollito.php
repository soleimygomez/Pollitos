<?php
   class Pollito{
    ...
    function __construct($id_pollo,$peso,$linea_genetica)
	{
    ...
    public static function save($pollito){
		...
		$insert=$db->prepare('INSERT INTO pollito VALUES (:id_pollo, :peso,:linea_genetica)');
	...
	public static function all(){
		...
		foreach($select->fetchAll() as $pollito){
			$listaPollos[]=new pollito($pollito['id_pollo'],$pollito['peso'],$pollito['linea_genetica']);
		}
		return $listaPollos;
	}
